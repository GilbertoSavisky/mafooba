...
//                                                  _atleta = atletaDestinatario.data.first;
//                                                }
...
//                                                  _atleta = atletaRemetente.data.first;
//                                                }
                                              }
                                            }
                                              ...
                                              child: ListTile(
                                                ...
                                                subtitle: Row(
                                                  children: <Widget>[
                                                    ...
                                                    Expanded(
                                                        child: Text('_batePapo.texto',
                                                          style: TextStyle(fontSize: 14, color: Colors.blue),overflow: TextOverflow.ellipsis,)),
                                                  ],
                                                ),
                                                trailing: Column(
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Container(
                                                      child: (
                                                          Image.asset(!_batePapo.visualizado ? 'images/chuteira1.png' : 'images/chuteira3.png', width: 35,)
                                                      ),
                                                    ),
                                                  ],
                                                ),
                                                onTap: (){
                                                  Navigator.push(
                                                    context,MaterialPageRoute(
                                                      builder: (context) => BatePapoPage(user, widget.currentUser)),
                                                  );
                                                },
